...
if (num1 > num2 && num1 > num3 ) {
    ...
    document.querySelector("h1").innerHTML = "Play 1 ,Play 2 Wins!"
} 
else if (num1 > num2 && num3 > num2 && num1 == num3) {
    document.querySelector("h1").innerHTML = "Play 1 ,Play 3 Wins!"
}
else if (num2 > num1 && num3 > num1 && num2 == num3) {
    document.querySelector("h1").innerHTML = "Play 2 ,Play 3 Wins!"
}else {
